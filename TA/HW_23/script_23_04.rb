...
# Number separated by comma(s) and double digits for cents

monthly_payment = "$1,654.55"
yearly_payment1 = monthly_payment.slice(1..-1).gsub(/\,/,'').to_f*12

yearly_payment2 = "%.2f" %yearly_payment1

yearly_payment = yearly_payment2.to_s.reverse.scan(/(?:\d*\.)?\d{1,3}-?/).join(',').reverse
