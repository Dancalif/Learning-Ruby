...
BEGIN{
    name = "Denis Umanets"
    description = "Testing Sign Up application version 3.0"
...
puts "==============================TITLE    :SIGN UP V3"

puts "==========Quotes verification"
# Test Case: Quotes existing
quote = browser.td(:id => "id_quotes") and quote.text.size > 0
if browser.td(:id => "id_quotes").exists?
...
if browser.link(:id => "id_link_facebook").exists?
...
if browser.link(:id => "id_link_twitter").exists?
...
if browser.link(:id => "id_link_flickr").exists?
...
if browser.link(:id => "id_link_youtube").exists?
...
if browser.button(:value => "  Reset  ").exists?
    ...
    puts "No text fields to enter the data"
